...
namespace Game1.Menu
{
    public static class MainMenuControls
    {
        ...
        public static List<Control> Controls(Game1 game, SubMenu menu) => new List<Control> {
            ...
            { new Control(game, menu, "Settings", ++index, ExecuteAction: OpenSettings)},
        ...
        public static void OpenSettings(Game1 game, MenuState menuState, SubMenu menu, Control me, PlayerIndex? playerIndex = null)
        {
            menuState.controlSelectSoundEffect.Play(game.soundLevel * 2f, 0f, 0f);
